...
modulationIndex = 1;  % QPSK modulation index
% System parameters
...
% Simulate QPSK modulation and apply Kalman filter
for k = 1:numSymbols
    % QPSK modulation
    data = randi([0, 3]); % 4 possible symbols in QPSK
    modulatedSymbol = exp(1i*pi/2*(2*data+1));
